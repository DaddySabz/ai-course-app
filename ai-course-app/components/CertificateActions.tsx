  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      <div className="p-6 rounded-3xl" style={{
        ...
        {/* Row 1: LinkedIn Add to Profile / LinkedIn / WhatsApp */}
        <div className="grid grid-cols-3 gap-3 mb-3">
          ...
          <button
            ...
            className="glass-mint-clickable flex flex-col items-center gap-2 p-4 rounded-2xl"
          >
        ...
        <div className="grid grid-cols-3 gap-3 mb-3">
          ...
          <button
            ...
            className="glass-peach-clickable flex flex-col items-center gap-2 p-4 rounded-2xl"
            title="Download image for Instagram + copy caption"
          >
        ...
        {typeof navigator !== 'undefined' && 'canShare' in navigator && isMobile() && (
          <div className="mb-3">
            <button
              ...
              className="glass-lavender-clickable flex items-center justify-center gap-3 p-4 rounded-2xl w-full"
            >
              <svg className="w-5 h-5" style={{ color: '#B8A8D4' }} fill="currentColor" viewBox="0 0 24 24">
                <path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92c0-1.61-1.31-2.92-2.92-2.92zM18 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM6 13c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm12 7.02c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z" />
              </svg>
              <span className="text-sm font-semibold text-text-primary">Share via...</span>
            </button>
          </div>
        )}
      </div>
