      ...
      <div className="glass p-6 rounded-3xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          ...
          <button
            ...
            className="glass-blue-clickable flex flex-col items-center gap-2 p-4 rounded-2xl"
          >
          ...
          <button
            ...
            className="glass-lavender-clickable flex flex-col items-center gap-2 p-4 rounded-2xl"
          >
          ...
          <button
            ...
            className="glass-clickable flex flex-col items-center gap-2 p-4 rounded-2xl"
          >
          ...
          <button
            ...
            className="glass-sage-clickable flex flex-col items-center gap-2 p-4 rounded-2xl"
          >
